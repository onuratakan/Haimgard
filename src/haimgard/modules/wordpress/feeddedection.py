...
class Module:
    def __init__(self, logger):
        self.logger = logger
        self.name = "wordpress/feeddedection"
        self.description = "WordPress feed detection."
    ...
    def run(self):
        ...
        print(f"\033[32m[+]\033[0m WordPress feed is detected on {url2}") if r.status_code == 200 else print(f"[-] WordPress feed is not detected on {url2}")
