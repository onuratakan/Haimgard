...
class Module:
    ...
    def run(self):
        ...
        print(f"\033[32m[+]\033[0m WordPress themes page is detected on {url2}") if r.status_code == 200 and r.text != "" else print(f"[-] WordPress themes page is not detected on {url2}")
